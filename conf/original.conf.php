...
return array(
	...
	'app_url' => 'http://demo.qt.hk/',
	
	// CDN 缓存的静态域名，如 http://static.domain.com/
	'static_url' => 'http://demo.qt.hk/',
	...
	'upload_url' => 'http://demo.qt.hk/upload/',
	
	'logo_url' => 'http://demo.qt.hk/',
	...
	// 插件目录对应的URL
	'plugin_url' => 'http://demo.qt.hk/plugin/',
	...
	// 点击服务器
	'click_server' => 'http://demo.qt.hk/service/clickd/',	// 记录主题点击数，论坛点击数
